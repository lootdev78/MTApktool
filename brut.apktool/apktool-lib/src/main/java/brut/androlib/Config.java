...
public class Config {
    ...
    private boolean mNetSecConfKeepExisting;
    ...
    /** Android port: optional direct framework APK selected by the UI. */
    public String getFrameworkFile() {
        return mFrameworkFile;
    }

    public void setFrameworkFile(String frameworkFile) {
        mFrameworkFile = frameworkFile;
    }
    ...
    /** Android/MT-style option: emit .registers instead of .locals in decoded smali. */
    public boolean isBaksmaliUseRegisters() {
        return mBaksmaliUseRegisters;
    }

    public void setBaksmaliUseRegisters(boolean baksmaliUseRegisters) {
        mBaksmaliUseRegisters = baksmaliUseRegisters;
    }
    ...
    public boolean isNetSecConfKeepExisting() {
        return mNetSecConfKeepExisting;
    }

    public void setNetSecConfKeepExisting(boolean keepExisting) {
        mNetSecConfKeepExisting = keepExisting;
    }
