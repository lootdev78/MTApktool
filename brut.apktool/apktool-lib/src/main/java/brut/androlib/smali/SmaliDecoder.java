...
public class SmaliDecoder {
    ...
    private final boolean mUseRegisters;
    private final Set<String> mDexFiles;
    private final AtomicInteger mInferredApiLevel;

    public SmaliDecoder(File apkFile, boolean debugMode, boolean useRegisters) throws AndrolibException {
    ...
    private void decodeFile(DexBackedDexFile dexFile, File smaliDir) {
        ...
        options.localsDirective = !mUseRegisters;
