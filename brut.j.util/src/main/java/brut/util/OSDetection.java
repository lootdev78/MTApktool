...
public final class OSDetection {
    private static final String OS = System.getProperty("os.name", "linux").toLowerCase();
    private static final String BIT = System.getProperty("sun.arch.data.model", "");
    private static final String ARCH = System.getProperty("os.arch", "").toLowerCase();
    private static final String RUNTIME = System.getProperty("java.runtime.name", "").toLowerCase();
    private static final String VM = System.getProperty("java.vm.name", "").toLowerCase();
    ...
    public static boolean is64Bit() {
        ...
        return BIT.equals("64") || ARCH.contains("64") || ARCH.contains("aarch64");
    }
