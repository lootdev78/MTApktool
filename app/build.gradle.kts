...
android {
    ...
    buildTypes {
        ...
        release {
            // Keep the first integrated Apktool release conservative: ANTLR/smali/apksig
            // include reflection-sensitive code paths that need device validation before shrinking.
